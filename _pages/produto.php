	...
	<div class="container">
		...
		<div class="col-sm-6 prod-lf">
			...
			<div class="box-share">
				...
				<a href="javascript: void(0);" onclick="window.open('https://twitter.com/intent/tweet?text=Gostei+de+um+produto+da+Malina&url=<?= urlencode(URLSite . ltrim($URISite,"/")) ?>&hashtags=malinabeauty','twitter', 'toolbar=0, status=0, width=650, height=450');"><i class="fa fa-twitter-square" aria-hidden="true"></i></a>
